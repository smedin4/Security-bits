...
| ** compute** (warm 8–16 vCore IR, tuned) | $0.274 / vCore-hour | **~$1,100–1,700** |
...
- The Delta approach only changes the **compute** line. The Data Flow used here is ~$1,100–1,700; alternative approaches considered — Copy plus an Azure Function (~$600–900) or Databricks (~$1,200–2,000 plus operations) — differ by only a few hundred dollars,ars) is small next to the egress.
